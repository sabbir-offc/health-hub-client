...
const Footer = () => {
  return (
    ...
    >
      <Grid
        container
        sx={{ position: "relative", mx: "auto", zIndex: 10, px: 2 }}
      >
        <Grid
          container
          display={"flex"}
        ...
        >
          <Box width="auto" p="8px">
            <Box display={"inline-flex"} alignItems="center">
              ...
              <Typography variant="h5" ml="16px" fontWeight="700">
                Diagonstic Center
              </Typography>
            </Box>
          </Box>
          <Box width="auto" p="32px">
            <List
              sx={{
                display: "flex",
          ...
          <Grid width="auto" p="32px">
            <Box m="-4px" display="flex" flexWrap={"wrap"}>
              <Box width={"auto"} p={"5px"}>
                <Box
                  display={"flex"}
                  height={"32px"}
                  width={"32px"}
